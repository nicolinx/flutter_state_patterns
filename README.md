...
| [`05_getx`](/lib/src/feature/article/presentation/05_getx)                   | **GetX**          | Reactive and minimal boilerplate pattern              |
| [`06_riverpod`](/lib/src/feature/article/presentation/06_riverpod)           | **Riverpod**      | Modern, type-safe, and testable approach              |
