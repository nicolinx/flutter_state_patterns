...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Article&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.image, image) || other.image == image));
}
...
@override
String toString() {
  return 'Article(id: $id, title: $title, image: $image)';
}
...
switch (_that) {
case _Article():
return $default(_that.id,_that.title,_that.image);}
}
...
class _Article implements Article {
   _Article({this.id, this.title, this.image});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Article&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.image, image) || other.image == image));
}
