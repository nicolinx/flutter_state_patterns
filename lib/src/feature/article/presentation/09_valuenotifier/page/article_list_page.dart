...
class ArticleListPage extends StatefulWidget {
  static const String routeName = '/valuenotifier/article-list';
  static const String routePath = '/valuenotifier/article-list';
...
class _ArticleListPageState extends State<ArticleListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Valuenotifier: Article List Page')),
